...
<br><br><br><br>
<?php 
include "Conexion_Quincenal.php"; 
?>
<style>
    body, html{
        background: rgb(63,94,251);
        background: radial-gradient(circle, rgba(63,94,251,1) 4%, rgba(252,70,107,1) 100%);
}
</style>
<body>
...
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
    ...
    <div class="flex-item text-center">
        ...
        <select id="selectDestino2"></select><ul><label for="selectDestino3">ID Reloj</label>
        <select id="selectDestino3"></select></ul></div>
...
<div class="box">
    ...
    <div class="flex-item text-center">
        ...
        <div class="value"><input type="text" name="horas_sencillas_Qui" id="horas_sencillas_Qui" class="suma" readonly></div>
    </div>
    <div class="flex-item text-center">
        <div class="detail"><label for="horas_extra_Qui">Horas Extra</label></div>
        <div class="value"><input type="text" name="horas_extra_Qui" id="horas_extra_Qui" class="suma" readonly></div>
    </div>
    <div class="flex-item text-center">
        <div class="detail"><label for="horas_dobles_Qui">Horas Dobles</label></div>
        <div class="value"><input type="text" name="horas_dobles_Qui" id="horas_dobles_Qui" class="suma" readonly></div>
    </div>
    <div class="flex-item text-center">
    ...
    <div class="flex-item text-center">
        ...
        <div class="value input"><input class="suma-input" type="text" name="total_Qui" id="total_Qui" readonly></div>
    </div>
</div>
    <br>
...
<br><br>
    <div class="box10"> 
        <form action="../CRUD Vyasa/generar_excel_Qui.php" method="post">
...
const feriados = document.getElementById('feriados_Qui');

// Obtener el elemento de entrada 'total' por su ID
const totalInput = document.getElementById('total_Qui');
...
function sumarHorasExtras() {
    ...
    const horas_extra =document.getElementById('horas_extra_Qui');
    document.getElementById('horas_extra_Qui').value = horasExtrasTotal;
}
</script>
...
function sumarHorasDobles() {
    ...
    var calculo_total = document.getElementById('total_Qui');

    const horasDoblesTotal = total1 + total2;
    document.getElementById('horas_dobles_Qui').value = horasDoblesTotal;
...
function sumatoria_horas() {
    ...
    const resultado_senci = document.getElementById('horas_sencillas_Qui');
